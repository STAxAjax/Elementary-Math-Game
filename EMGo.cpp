	...
	do{
		...
		switch (page){
			case 1 :
				...
				printf ("-	Every question you answer correctly will add 10(?) to your score.\n");
				break;
			case 2 :
				printf("\nDifficulties & Operators\n");
				printf ("Page %d\n", page);
				...
				printf ("-	Every question you answer correctly will add 15(?) to your score.\n");
				break;
			case 3 :
				printf("\nDifficulties & Operators\n");
				printf ("Page %d\n", page);
		...
		printf ("Page down | Page up | Back [A|D|0]\n >>> ");
